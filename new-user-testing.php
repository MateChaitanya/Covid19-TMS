...
<head>
    ...
    <style>
        body {
            /* background-image: url("https://unsplash.com/photos/visualization-of-the-coronavirus-causing-covid-19-rnr8D3FNUNY");
...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">Covid19-Testing Management System</a>
                        ...
                        <div class="row" >
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="fullname" name="fullname"
                                                placeholder="Enter your full name..." pattern="[A-Za-z ]+"
                                                title="letters only" required="true">
                                        </div>
                                        <div class="form-group">
                                            <label class="text-light">Mobile Number</label>
                                            <input type="text" class="form-control" id="mobilenumber"
                                                name="mobilenumber" placeholder="Please enter your mobile number"
                                                pattern="[0-9]{10}" maxlength="10" title="10 numeric characters only" required="true"
                                        ...
                                        <div class="form-group">
                                            <label class="text-light">Any Govt Issued ID</label>
                                            <input type="text" class="form-control" id="govtissuedid"
                                                name="govtissuedid" maxlength="14"
                                                placeholder="Pancard / Driving License / Voter id / any other"
                                                required="true">
                                        </div>
                                        <div class="form-group">
                                            <label class="text-light">Govt Issued ID Number</label>
                                            <input type="text" class="form-control" id="govtidnumber"
                                                name="govtidnumber" placeholder="Enter Goevernment Issued ID Number"
                                                required="true">
                                        </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class=" shadow mb-4">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label class="text-light">Test Type</label>
                                        ...
                                        <div class="form-group">
                                            <label class="text-light">Time Slot for Test</label>
